...
import cn.xls.icf.flowable.service.inf.IInstanceService;
...
public class InstanceController {
	...
	public ResponseData startByName(String name, String tenantId, @RequestBody Map<String, Object> variables) {
		ProcessInstance pi = instanceService.startProcessInstanceByKeyAndTenantId(name, tenantId, variables);
		List<Task> list = taskQueryService.processInstanceId4Multi(pi.getProcessInstanceId());
	...
	public ResponseData<TaskVO> startById(String id, @RequestBody Map<String, Object> variables) {
		ProcessInstance pi = instanceService.startProcessInstanceById(id, variables);
		Task task = taskQueryService.processInstanceId(pi.getProcessInstanceId());
	...
	public ResponseData startAndExecute(String name, String tenantId, String userId,
			@RequestBody Map<String, Object> variables) throws Exception {
		Map<String, Object> map = instanceService.startInstanceAndExecuteFirstTask(name, tenantId, userId, variables);
	...
	public ResponseData addMultiInstanceExecution(String activityDefId, String instanceId,
			@RequestBody Map<String, Object> variables) {
