...
@Slf4j
@Component
public class InstanceServiceImpl extends ServiceFactory implements IInstanceService {

    protected static Logger logger = LoggerFactory.getLogger(InstanceServiceImpl.class);
    @Autowired
